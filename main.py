...
def weight(spot1, spot2):
    # Return the weight of the edge between spot1 and spot2
    return h(spot1.get_pos(), spot2.get_pos())
...
def dijkstra(draw, grid, start, end):
    ...
    while not priorityQueue.empty():
        ...
        for neighbor in spot.neighbors:
            new_distance = distance[spot] + weight(spot, neighbor)
            if new_distance < distance[neighbor]:
                distance[neighbor] = new_distance
                shortest_path[neighbor] = spot
        ...
        for event in pygame.event.get():
            ...
            if pygame.mouse.get_pressed()[0]:  # LEFT
                ...
                if spot == start:
                    ...
                    # druk op spatie om A* algortihme te starten
            if event.type == pygame.KEYDOWN:
                if event.key == pygame.K_SPACE and start and end:
                    ...
                    #druk op "Q" om dijkstra algorithme te starten
